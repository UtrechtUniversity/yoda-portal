    ...
    context: (_, __, row) => {
        ...
        if (row.type === 'coll') {
            ...
            if (row.state === 'OFL') {
                ...
                actions.append(`<a class="dropdown-item" href="browse/download?filepath=${encodeURIComponent(currentFolder + '/' + row.name)}" data-name="${htmlEncode(row.name)}" title="Download this file">Download</a>`);
