...
class YodaButtons extends React.Component {
  ...
  renderCloneButton () {
    return (<button onClick={this.props.cloneMetadata} type='button' className='btn btn-primary clone-metadata-btn me-3' title='Clone from parent folder'>Clone</button>) // eslint-disable-line react/jsx-handler-names
  }
  ...
  renderCloseButton () {
    return (<a className='btn btn-secondary' href={'/research/browse?dir=' + encodeURIComponent(path)} title='Close metadata form'>Close</a>)
  }
