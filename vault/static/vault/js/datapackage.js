...
function metadataShow() {
    ...
    if (metadata['Data_Access_Restriction'] == "Open - freely retrievable") {
        $(".metadata-access").html('<span class="badge rounded-pill bg-success me-2 float-end"><h6><i class="fa-solid fa-lock-open"></i> Open</h6></span>');
    } else {
        $(".metadata-access").html('<span class="badge rounded-pill bg-warning me-2 float-end"><h6><i class="fa-solid fa-lock"></i> Restricted</h6></span>');
    }
