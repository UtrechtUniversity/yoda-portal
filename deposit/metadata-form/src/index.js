...
import CustomArrayFieldTemplate from 'YodaTemplates/CustomArrayFieldTemplate'
import CustomErrorListTemplate from 'YodaTemplates/CustomErrorListTemplate'
...
class YodaButtons extends React.Component {
  renderBackButton () {
    return (<button onClick={this.props.backButton} type='submit' className='btn btn-secondary float-start btn-step-upload'><i className='fa-solid fa-chevron-left' /> Upload data</button>) // eslint-disable-line react/jsx-handler-names
  }

  renderSubmitButton () {
    return (<button onClick={this.props.submitButton} type='submit' className='btn btn-primary float-end btn-step-submit'>Submit datapackage <i className='fa-solid fa-chevron-right' /></button>) // eslint-disable-line react/jsx-handler-names
  }
  ...
  renderButtons () {
    ...
    if (formProperties.data.can_edit) {
      ...
      if (formProperties.data.metadata !== null) { buttons.push(this.renderDeleteButton()) }
    }
